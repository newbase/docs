    ...
    return (
        <div className="flex items-center gap-2">
            <SelectCombo
                ...
                triggerClassName="h-10 bg-white"
            />
            <div className="flex items-center gap-1 bg-white border border-input rounded-md px-2 h-10">
                <input
                    type="number"
                    min="1"
                    max="12"
                    ...
                    className="w-10 text-center text-sm border-none outline-none appearance-none bg-transparent"
                    placeholder="12"
                />
