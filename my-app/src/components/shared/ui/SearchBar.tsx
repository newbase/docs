...
export default function SearchBar({ value, onChange, placeholder = "Search...", className, style }: SearchBarProps) {
    return (
        <div
            className={`flex items-center max-w-sm h-[38px] rounded-md border border-gray-200 bg-white px-3 py-2 text-sm ring-offset-white focus-within:ring-2 focus-within:ring-blue-300 focus-within:ring-offset-1 ${className || ''}`}
            style={style}
        >
