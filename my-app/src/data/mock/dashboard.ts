/**
 * 목업 대시보드 데이터
 * 실제 API 연동 시 data/queries/useDashboard.ts로 대체
 */
...
export const studentMockData = {
    ...
    fullHistoryData: [
        { id: 1, createdDate: '2025.12.06', title: '핵심술기: 활력징후 측정', category: 'Essential Skills', mode: 'training' as const, score: 85, duration: '15:20', status: 'completed' as const, classId: '001', sessionId: 'session-1' },
        { id: 2, createdDate: '2025.12.05', title: '질환심화: 심근경색(MI) 케어', category: 'Disease Knowledge', mode: 'evaluation' as const, score: 92, duration: '22:10', status: 'completed' as const, classId: '001', sessionId: 'session-2' },
