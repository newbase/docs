...
import type { CreateProductRequestDto } from '@/types/api/product';
...
export default function AddProductModal({
	...
	return (
		<Modal isOpen={isOpen} onClose={onClose} title="상품 등록" footer={footer} size="large">
