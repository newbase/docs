...
export default function OpenClassCreate(): React.ReactElement {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (useMock) {
                // Mock behavior
                console.log('Mock: Creating open class', {
                    className,
                    price: price,
                    visibility
                });
                await new Promise(resolve => setTimeout(resolve, 1000));
                alert('오픈클래스가 생성되었습니다! (Mock)');
                navigate(-1);
                return;
            }
            ...
            alert('오픈클래스가 생성되었습니다!');
            navigate(-1);
        } catch (error) {
            console.error('Error creating open class:', error);
            alert('오픈클래스 생성 중 오류가 발생했습니다.');
        } finally {
